/*
DOM_ALGH_Controller.cpp
DOM-ALGH - Projeto Domino
2023
*/

#include "Dom_ALGH_Controller.h"
#include "Dom_ALGH_View.cpp"
#include <time.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
int pedras_mao = 0;
	...
	ou se o o jogo for contra o computador, e estiver na vez de uma pessoa(jvez != playerAuto), se for vez do computador(jvez == playerAuto), já se tem essa informacao.*/
